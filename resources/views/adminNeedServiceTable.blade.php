      ...
      <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
              <div class="modal-body text-center">
                <h2 class="p-3">Are you sure you want to delete this user?</h2>
                <h2 class="d-none" id="getID1"></h2>
              </div>
              <div class="modal-footer">
                  <button data-id="" id="getID" type="button" class="getID btn btn-danger">Delete</button>
...
@section('script')
<script src="{{URL::asset('js/adminNeedServiceTable.js') }}"></script>
<script>
    getData();
</script>
