...
<head>
    ...
    <link rel="shortcut icon" href="images/logo-main.jpg" type="image/x-icon">
...
<body onload="myFunction()">
    ...
    <header>
        ...
        <div class="header-middle">
            <div class="logo"><img style="width: 200px; border-radius: 50%;" src="images/logo-main.png.jpg" alt=""></div>
            ...
            <div class="icons">
                ...
                <a href="https://www.facebook.com/messages/t/304654760235466"><i class="fab fa-facebook-messenger" aria-hidden="true"></i></a>
        ...
        {{-- <div class="caurosel-container">
            <div id="carouselExampleIndicators" class="carousel slide amar-caurosel" data-bs-ride="carousel">
...
<script>
    ...
    chatbox.setAttribute("page_id", "304654760235466");
...
<script>
    ...
    document.querySelector(".faq-que").addEventListener("click", function () {

        document.querySelector(".faq-que span").classList.toggle("active-faq")

        document.querySelector('.faq li').classList.toggle("active-faq")

    });


    document.querySelector(".faq-que2").addEventListener("click", function () {

        document.querySelector(".faq-que2 span").classList.toggle("active-faq")

        document.querySelector('.secondLi').classList.toggle("active-faq")

    });

    document.querySelector(".faq-que3").addEventListener("click", function () {

        document.querySelector(".faq-que3 span").classList.toggle("active-faq")

        document.querySelector('.thirdLi').classList.toggle("active-faq")

    });

    document.querySelector(".faq-que4").addEventListener("click", function () {

        document.querySelector(".faq-que4 span").classList.toggle("active-faq")

        document.querySelector('.fourthLi').classList.toggle("active-faq")

    });
    
    document.querySelector(".faq-que5").addEventListener("click", function () {

        document.querySelector(".faq-que5 span").classList.toggle("active-faq")

        document.querySelector('.fifthLi').classList.toggle("active-faq")
